...
export default function Marcomit() {
  return (
    <div>
        <a style={{position: 'absolute', fontSize: 30, top: 30, left: 30, color: '#fff'}} href="/"><FaArrowLeft/></a>
        <div className='work-page'>
            <div className="work-page__image">
                <img src="https://assets-global.website-files.com/65455474e0ea54684cf7d9cf/65455474e0ea54684cf7da30_martin-katler-rjASNUw3SDE-unsplash-min.jpg" alt="#" />
            </div>
            <div>
                <h2>Marcomit</h2>
                ...
                <div className='work-page__columns'>
                    <div><h3>Client</h3><p>Clipper</p></div>
        ...
        <WorkPageText />
        <Work titlePage={'Other Works'} elem={1}/>
    </div>
  )
}
